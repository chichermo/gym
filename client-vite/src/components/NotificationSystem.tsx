...
import { Bell, X, Check, AlertTriangle, Info, Trophy, Flame } from 'lucide-react';
import { useAuth } from '../contexts/AuthContext';

interface Notification {
  _id: string;
  type: 'info' | 'success' | 'warning' | 'error' | 'achievement' | 'workout';
  title: string;
  message: string;
  read: boolean;
  createdAt: string;
...
const mockNotifications: Notification[] = [
  {
    ...
    data: { achievementId: 'achievement2' }
  },
  {
    _id: 'notif2',
    type: 'workout',
    title: 'Recordatorio de Entrenamiento',
    message: 'Es hora de tu entrenamiento de piernas programado',
    read: false,
    createdAt: '2024-06-26T07:00:00Z',
    data: { workoutId: 'workout4' }
  },
  {
    _id: 'notif3',
    type: 'success',
    ...
    read: true,
    createdAt: '2024-06-25T18:45:00Z',
    data: { progressId: 'progress1' }
  },
  {
    _id: 'notif4',
    type: 'info',
    title: 'Consejo del Día',
    message: 'Recuerda mantener una buena hidratación durante tus entrenamientos',
    read: true,
  ...
  },
  {
    ...
    message: 'Has entrenado 6 días seguidos. Considera tomar un día de descanso',
    read: true,
    createdAt: '2024-06-24T20:30:00Z'
  }
];
          ...
          <div className="max-h-96 overflow-y-auto">
            {loading ? (
              ...
              <div className="p-8 text-center text-gray-500">
                <Bell className="text-3xl mx-auto mb-2 text-gray-300" />
