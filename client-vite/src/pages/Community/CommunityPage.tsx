    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex flex-col">
      ...
      <div className="w-full bg-gradient-to-r from-amber-200 via-yellow-100 to-orange-100 border-b border-amber-300 py-3 px-4 flex items-center justify-center shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-amber-800 text-sm font-semibold">Modo DEMO: Datos simulados de comunidad</span>
        </div>
      </div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-1">Conecta con otros fitness enthusiasts</p>
            </div>
          </div>
        </div>
