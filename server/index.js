...
// Rutas básicas (sin wearables por ahora)
...
app.get('/api/docs', (req, res) => {
  res.json({
    success: true,
    message: 'BRO FIT API Documentation',
    version: '1.0.0',
    endpoints: {
      auth: {
...
// Conexión a MongoDB (opcional en desarrollo)
if (process.env.NODE_ENV === 'production') {
  ...
  logger.info('🔧 Modo desarrollo: MongoDB no requerido');
}
